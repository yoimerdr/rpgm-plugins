...
### Added
- Modular engine error interception system (intercepts caught engine errors, window `onerror` events, and unhandled promise rejections to report them to the native Ludens bridge).
