...
declare class Window_BattleLog extends Window_Selectable {
  ...
  public showEnemyAttackAnimation(
    subject: Game_Battler,
    targets: Game_Battler[],
  ): void;
...
declare class Game_Message {
  ...
  public setChoices(
    choices: string[],
    defaultType: ChoiceDefaultType,
    cancelType: ChoiceCancelType,
  ): void;
...
declare class Game_Interpreter {
  ...
  public iterateEnemyIndex(
    index: number,
    callback: (actor: Game_Enemy) => void,
  ): void;
  public iterateBattler(
    isActor: number,
    param2: number,
    callback: (actor: Game_Battler) => void,
  ): void;
...
declare class Game_Actor extends Game_Battler {
  ...
  public tradeItemWithParty(
    newItem: RPG_EquipBase,
    oldItem: RPG_EquipBase,
  ): boolean;
...
declare class SceneManager {
  ...
  public static onError(e: ErrorEvent): void;
...
declare class BattleManager {
  ...
  public static invokeNormalAction(
    subject: Game_Battler,
    target: Game_Battler,
  ): void;
  ...
  public static invokeMagicReflection(
    subject: Game_Battler,
    target: Game_Battler,
  ): void;
...
declare class AudioManager {
  ...
  public static updateSeParameters(
    buffer: Html5Audio,
    se: { name: string },
  ): void;
  public static updateSeParameters(
  ...
  public static updateBufferParameters(
    buffer: Html5Audio,
    configVolume: number,
    audio: { volume: number; pitch: number; pan: number },
  ): void;
  public static updateBufferParameters(
    buffer: WebAudio,
    configVolume: number,
...
interface DataState extends RPG_ItemBase {
...
declare class WindowLayer extends PIXI.Container {
  ...
  protected _canvasClearWindowRect(
    renderSession: PIXI.SystemRenderer,
    window: Window,
  ): void;
  ...
  protected _webglMaskWindow(
    renderSession: PIXI.SystemRenderer,
    window: Window,
  ): void;
  protected _webglMaskRect(
    renderSession: PIXI.SystemRenderer,
    x: number,
    y: number,
    w: number,
